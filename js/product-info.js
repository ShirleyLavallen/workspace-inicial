             ...
             <div class="w-100">
               ...
               <div class="d-flex justify-content-between align-items-center">
                 <p class="small mb-0" style="color: #aaa;">
                   <a class="link-grey remove" style="cursor: pointer" onclick="deleteComment(this);">Eliminar</a> •
                   <a class="link-grey edit" style="cursor: pointer" onclick="showEditCommentForm(this);">Editar</a> 
                 </p>
